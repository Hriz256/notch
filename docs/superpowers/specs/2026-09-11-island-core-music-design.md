...
- `MusicCompactView` — left slot: 18 pt artwork thumbnail with 4 pt radius; right slot: `VisualizerBars` (4 bars, animated with staggered `repeatForever` scale when playing, frozen at low height when paused).
